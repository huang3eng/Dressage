...
DRESSAGE_TRAJECTORY_PAYLOAD_LOG_DIR=${DRESSAGE_TRAJECTORY_PAYLOAD_LOG_DIR:-/root/log/trajectory_payload/hotpotqa-qwen3.5-4B}
DRESSAGE_TRAJECTORY_ERROR_LOG_DIR=${DRESSAGE_TRAJECTORY_ERROR_LOG_DIR:-/root/log/trajectory_err/hotpotqa-qwen3.5-4B}
